...
<div>
        <span>省份&nbsp;&nbsp;</span>
    <span>
    <select id="b2_s_s"><option value="">请选择</option></select>
    </span>&nbsp;&nbsp;&nbsp;&nbsp;
     
      <span>地区&nbsp;&nbsp;</span>
    <span>
    <select id="b3_s_s"><option value="">请选择</option></select>
    </span>&nbsp;&nbsp;&nbsp;&nbsp;
...
function initIndex(){
    ...
    var province = document.getElementById('b2_s_s');
...
$(document).on("change","#b2_s_s",function(){
    var province = document.getElementById("b2_s_s");
    var num = province.selectedIndex; // 选中option索引
    var city = document.getElementById('b3_s_s');
