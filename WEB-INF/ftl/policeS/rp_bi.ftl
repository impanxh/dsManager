<#import "../template/template.ftl" as frame> <#global menu="巡检汇总表">
<@frame.html title="巡检汇总表"
    ...
    function initTable () {
        table = $('#table').dataTable( {
            ...
            "columns": [
                ...
                { "data": "p.3check","defaultContent": ""  },
                { "data": "p.3notpass","defaultContent": ""  },
                
                { "data": "p.1check","defaultContent": ""  },
                { "data": "p.1notpass","defaultContent": ""  },
                { "data": "p.2check","defaultContent": ""  },
                { "data": "p.2notpass","defaultContent": ""  },
