...
<script type="text/javascript">
    ...
    function initTable () {
        table = $('#table').dataTable( {
            ...
            "ajax": {
                type: "GET",
                url: "${rc.contextPath}/user/ajax-roleList?rev_=3",
                data: function(d) {
                 return $.extend( {}, d, {
                        "name_" : $('#name').val()
                    } );
...
<div class="withdraw-wrap color-white-bg fn-clear">
	<div class="withdraw-title">
		${menu!''} <a class="block-btn" href="${rc.contextPath}/user/addRole?rev_=3">添加角色</a>
	</div>
	<table id="table" class="display" cellspacing="0" width="100%">
		<thead>
			<tr>
				<th orderBy="NAME_">角色名称</th>
				<th orderBy="ID_">角色简码</th>
				<th>权限</th>
				<th>操作</th>
			</tr>
		</thead>
