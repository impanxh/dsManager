...
<section class="g-flexview">
    ...
    <section class="g-scrollview">
        ...
        <form data-name="withdraw" name="submitForm" id="submitForm" class="ui-form"
              ...
              -->
        <h1 class="demo-pagetitle">更新物防信息</h1>
        ...
        <div class="m-cell">
            <div class="cell-item">
                <div class="cell-right">
                    <textarea  name="detailDesc_s" id="detailDesc" class="cell-textarea" placeholder="请追加补充说明"></textarea>
                </div>
            </div>
        </div>
        ...
        <div class="m-cell">
            <div class="cell-item">
                <div class="cell-right ">
                        <article style="width:100%;margin-bottom:20px;" class="m-list list-theme1 clearfix" id ="imageShow">
                        </article>
...
<script>
    ...
    function submit() {
        var params = {
            ...
            "mediaFile_s": $("#mediaFile").val(),
               "wordInfo_s": JSON.stringify(WORDJSON_MAP),
        ...
        var settings = {
            "async": false,
            "crossDomain": true,
            "url": "http://" + changeAddr() + "/common/saveModel?className=EquipPrecaution&checkUniq=Y&UID=<@security.authentication property="principal.username" />",
            "method": "POST",
            "data": params
        }
        $.ajax(settings).done(function(response) {
            window.location.href = "${rc.contextPath}/equipPrecaution/EPList?unit=" + $("#unitId").val();
    ...
    $(document).ready(function() {
        ...
        if( myEP != null) {
            ...
            if(myEP.s_Map.mediaFile_s != null) {
            	var _WORDJSON_MAP = {};
                ...
                $("#mediaFile").val(myEP.s_Map.mediaFile_s);
