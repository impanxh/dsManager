...
<section class="g-flexview">
    <header class="m-navbar">
        ...
        <div class="navbar-center"><span class="navbar-title" id="unitTitle">消防演练记录</span></div>
        <a href="javascript:void(0);" onclick="AddEdu()" class="navbar-item">添加记录</a>
    </header>

    <section class="g-scrollview" id="issueSection">

        <h1 class="demo-pagetitle" id="unitTitle">消防演练记录</h1>
    ...
    <script id="issueTemplate" type="text/html">
        <div class="m-cell"  >
            {{each list as data}}
            <a href="${rc.contextPath}/mindPrecaution/editdrill?id={{data.id}}" class="cell-item J_Link"<#-- j_link比较重要需要加--> data-page="{{page}}">
                <div class="cell-left">
...
<script>
    ...
    function AddEdu() {            
        window.location.href = "${rc.contextPath}/mindPrecaution/editdrill?unit=" + unitId;
    } 
    function GotoBase() {            
