...
<section class="g-flexview" id="app">
    <header class="m-navbar">
        ...
        <div class="navbar-center">
            <span class="navbar-title">{{details.s_Map.unitName_s}}</span>
        </div>
    </header>
    ...
    <section class="g-scrollview">
           ...
           <#--  <div class="cell-item">
            ...
            <div class="m-button" style="width: 100%;">
                <a :href="baseEditUrl">
    			<button type="button" id="savebt" class="btn-block btn-primary">信息编辑</button>
                </a>
			</div>
   	</section>
</section>
...
var baseMap ;
    	...
    	var modVue = new Vue({
            el: '#app',
                data: {
                    baseEditUrl: "unitEdit?edit=1&placeId=" + placeId,
                    datas: {},
                    region:{},
                    details:{},
                    imageUrl:'',
